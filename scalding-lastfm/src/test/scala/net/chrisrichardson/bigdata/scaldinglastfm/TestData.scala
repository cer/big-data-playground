...
object TestData {
  ...
  val plays = List(
    ...
    ("user1", "2012-01-04T13:54:10Z", "chic-id", "Chic", "everybody-dance-id", "Everybody Dance"),
    ("user2", "2006-03-08T23:08:57Z", "chic-id", "Chic", "le-freak-id", "Le Freak")
  )

  val playsWithNoTrackIds = List(("user1", "2006-03-04T23:08:57Z", "chic-id", "Chic", "", "Forbidden Lover")) ++ plays
  ...
  val usersAndPlays = List(
    ...
    ("user1", "2012-01-04T13:54:10Z", "chic-id", "Chic", "everybody-dance-id", "Everybody Dance", "m", "34", "USA", user1_signup),
